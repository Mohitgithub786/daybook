...
[Live Demo](https://daybook-mohit.vercel.app)

Head over to the [Vercel deployment branch](https://github.com/Mohitgithub786/daybook/tree/deployment) if you want to see how the deployment is set up (you can find the relevant details in their `package.json` file).
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/Mohitgithub786/daybook.git
